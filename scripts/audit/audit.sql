    ...
    CREATE USER AUDIT_USER IDENTIFIED BY 123
    DEFAULT TABLESPACE USERS
    TEMPORARY TABLESPACE TEMP
    QUOTA UNLIMITED ON USERS;
    
    GRANT CONNECT, RESOURCE TO AUDIT_USER;
    GRANT CREATE ANY TRIGGER TO AUDIT_USER;
/
GRANT INSERT, SELECT, DELETE, UPDATE ON DEV.HFORNECEDORES TO AUDIT_USER;
GRANT INSERT, SELECT, DELETE, UPDATE ON DEV.HPEDIDOS TO AUDIT_USER;
GRANT INSERT, SELECT, DELETE, UPDATE ON DEV.HPEDIDOS_PRODUTOS TO AUDIT_USER;
GRANT INSERT, SELECT, DELETE, UPDATE ON DEV.HPRODUTOS TO AUDIT_USER;
GRANT INSERT, SELECT, DELETE, UPDATE ON DEV.HQUALIDADES TO AUDIT_USER;
GRANT INSERT, SELECT, DELETE, UPDATE ON DEV.HSTATUS TO AUDIT_USER;
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  AUDIT_USER."SEQ_AUD"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOCYCLE;
/
--------------------------------------------------------
--  DDL for Table AUDITORIA
--------------------------------------------------------

  CREATE TABLE AUDIT_USER."AUDITORIA" 
   (	
     "AUD_ID" NUMBER(6,0), 
...
--------------------------------------------------------
  ...
  ALTER TABLE AUDIT_USER."AUDITORIA" ADD CONSTRAINT "PK_AUD" PRIMARY KEY ("AUD_ID");
/
--------------------------------------------------------
--  DDL for Trigger TG_SEQ_AUD
--------------------------------------------------------

CREATE OR REPLACE TRIGGER AUDIT_USER."TG_SEQ_AUD" BEFORE INSERT ON AUDIT_USER.AUDITORIA
FOR EACH ROW
BEGIN
...
/
ALTER TRIGGER AUDIT_USER."TG_SEQ_AUD" ENABLE;
/
--------------------------------------------------------
...
set define off;
  ...
  CREATE OR REPLACE PROCEDURE AUDIT_USER."PROC_AUDITORIA" (
...
IS
BEGIN
    INSERT INTO AUDIT_USER.AUDITORIA VALUES (null,P_AUD_TABELA,P_AUD_OPERACAO,P_AUD_HIST_ID,P_AUD_COLUNA,P_AUD_VALOR_ANTIGO,P_AUD_VALOR_NOVO,P_AUD_USU_BD,P_AUD_USU_SO,P_AUD_DATA);
END;
...
--------------------------------------------------------
/
CREATE OR REPLACE TRIGGER AUDIT_USER.TG_AUD_FORNECEDORES 
...
END;
/
ALTER TRIGGER AUDIT_USER."TG_AUD_FORNECEDORES" ENABLE;
--------------------------------------------------------
--  DDL for Trigger TG_AUD_PEDIDOS
--------------------------------------------------------

CREATE OR REPLACE TRIGGER AUDIT_USER."TG_AUD_PEDIDOS" 
...
END;
/
ALTER TRIGGER AUDIT_USER."TG_AUD_PEDIDOS" ENABLE;

--------------------------------------------------------
--  DDL for Trigger TG_AUD_PEDIDOS_PRODUTOS
--------------------------------------------------------

CREATE OR REPLACE TRIGGER AUDIT_USER."TG_AUD_PEDIDOS_PRODUTOS" 
...
END;
/
ALTER TRIGGER AUDIT_USER."TG_AUD_PEDIDOS_PRODUTOS" ENABLE;

--------------------------------------------------------
--  DDL for Trigger TG_AUD_PRODUTOS
--------------------------------------------------------

CREATE OR REPLACE TRIGGER AUDIT_USER."TG_AUD_PRODUTOS" 
...
END;
/
ALTER TRIGGER AUDIT_USER."TG_AUD_PRODUTOS" ENABLE;

--------------------------------------------------------
--  DDL for Trigger TG_AUD_QUALIDADES
--------------------------------------------------------

CREATE OR REPLACE TRIGGER AUDIT_USER."TG_AUD_QUALIDADES" 
...
END;
/
ALTER TRIGGER AUDIT_USER."TG_AUD_QUALIDADES" ENABLE;

--------------------------------------------------------
--  DDL for Trigger TG_AUD_STATUS
--------------------------------------------------------

CREATE OR REPLACE TRIGGER AUDIT_USER."TG_AUD_STATUS" 
...
END;
/
ALTER TRIGGER AUDIT_USER."TG_AUD_STATUS" ENABLE;
